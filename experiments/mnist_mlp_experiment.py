# =============================================================================
# MNIST / MLP experiment — bipropagation reproduction & decomposition study.
#
# Self-contained TensorFlow 2 / Keras script. Runs in a single Colab cell or
# locally. It implements and compares, on a shared deep narrow MLP and a shared
# MNIST data pipeline:
#   - vanilla backprop        (naive init, tanh, SGD)
#   - modern backprop         (He init + BatchNorm + Adam)
#   - layer-wise bipropagation (Ploj-style anchors: hand-designed intermediate
#                               targets, near-identity init, softmax readout)
#   - deterministic bipropagation (analytic centroid-geometry hidden layer)
#
# and runs the three "headline claim" tests (speed, reliability across seeds,
# depth scaling) plus a low-data efficiency bonus.
#
# Set the FAST_MODE flag below to False for the full benchmark; True gives a
# fast indicative smoke run. All reported numbers come from actual evaluation
# runs (nothing is hardcoded).
#
# This file is a clean, relocated copy of the original combined script
# (auto-generated from Bipropagation_Comparison.ipynb). Comments in the body
# are in Slovenian, matching the working analysis in ANALYSIS_sl.md.
# =============================================================================

# Bipropagation vs Backpropagation - posten test treh trditev (zdruzena skripta)
# Avtogenerirano iz Bipropagation_Comparison.ipynb za zagon v eni Colab celici.
...
# ======================================================================
# TEST ★ Bonus: učinkovitost s podatki (low-data režim)
# ======================================================================
